...
// Change my dog's type to hairless using square bracket notation
var myOtherDog = {
	type: 'poodle',
	name: 'Fluffy'
};
...
var A_Ray = [1, 2, 'a', 1, 3, 'a', 4, 1, 5]

function removeThings(arr, deleteValue) {
...
console.log(removeThings(A_Ray, 1))
...
console.log(tripleTheFun('Awesome'))
...
console.log(clockIn('Carter', 'DevM'));
...
function spiderTest(obj){
  ...
  else obj.spiderRating = 'not a spiderman'
}
...
function whatIsItOutside(temp, humid, cloud){
  ...
  else if(temp > 85 && humid < 45 && cloud < 20){
